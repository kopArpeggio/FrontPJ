...
function Autocomp({ formData, setFormData, sethouseregis, houseregis }) {
    ...
    <div>
      <Row className="mb-3 mt-5">
        <Form.Group as={Col} controlId="formGridEmail">
          ...
          <Form.Control type="text" placeholder="ชื่อจริง" value={formData.firstname}
            onChange={(event) =>
        ...
        <Form.Group as={Col} controlId="formGridPassword">
          ...
          <Form.Control type="text" placeholder="นามสกุล" disabled value={formData.lastname} />
        </Form.Group>
      </Row>
      <Row className="mb-3">
        <Form.Group as={Col} controlId="formGridEmail">
      ...
      <Row className="mb-3">
        <Form.Group as={Col} controlId="formGridEmail">
          ...
          <Form.Control type="tel" maxLength="10" value={formData.phoneNum}
            onChange={(event) =>
      ...
      <Row className="mb-3">
        <Form.Group as={Col} controlId="formGridEmail">
          ...
          <Form.Control type="text" placeholder="ซม." value={formData.height}
            onChange={(event) =>
        ...
        <Form.Group as={Col} controlId="formGridPassword">
          ...
          <Form.Control type="text" placeholder="กก." value={formData.weight}
            onChange={(event) =>
      ...
      <Row className="mb-3 ">
        <Form.Group as={Col} sm='5' controlId="formGridEmail">
          ...
          <Form.Control type="text" placeholder="ชื่อจริง" value={formData.fathername}
            onChange={(event) =>
        ...
        <Form.Group as={Col} sm='2' controlId="formGridPassword">
          ...
          <Form.Control type="text" placeholder="เกษตกร" value={formData.fatherjob}
            onChange={(event) =>
      ...
      <Row className="mb-3 ">
        <Form.Group as={Col} sm='5' controlId="formGridEmail" >
          ...
          <Form.Control type="text" placeholder="ชื่อจริง" value={formData.mothername}
            onChange={(event) =>
        ...
        <Form.Group as={Col} sm='2' controlId="formGridPassword">
          <Form.Label>อาชีพ</Form.Label>
          <Form.Control type="search" placeholder="ข้าราชการครู" value={formData.motherjob}
            onChange={(event) =>
