        ...
        if (results.isConfirmed) {
          const done = await updateEvaluateById({
            ...
            fcn9_2Point:
              ...
              score?.score19 +
              score?.score20,
            fcn9_2Strength: score?.fcn9_2Strength,
            fcn9_2Improvement: score?.fcn9_2Improvement,
          });
          ...
          <Form noValidate validated={validated} onSubmit={handleSubmit}>
            ...
            <Form.Group as={Row} controlId="exampleForm.ControlInput1">
              ...
              <Col sm={3} className="d-flex justify-content-start">
                ...
                <Form.Control min={1} max={10} type="number" required onChange={(e) =>
            ...
            >
              ...
              <Col sm={3} className="d-flex justify-content-start">
                ...
                <Form.Control min={1} max={10} type="number" required onChange={(e) =>
                  setScore({ ...score, score20: parseInt(e?.target.value) })
                } />
              </Col>
            </Form.Group>
            ...
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
              ...
              <Form.Control
              onChange={(e) => {
                  setScore({ ...score, fcn9_2Strength: e?.target?.value})
              }}
                as="textarea"
                required
                style={{ height: "100px" }}
            ...
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
              ...
              <Form.Control
                onChange={(e) => {
                  setScore({ ...score, fcn9_2Improvement: e?.target?.value })
                }}
                as="textarea"
                required
                style={{ height: "100px" }}
