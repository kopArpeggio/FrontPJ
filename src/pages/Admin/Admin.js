...
export default function Admin() {
    ...
    const Update = () => {
        setadd(false);
        console.log(compdetail.distri, compdetail.amphoe, compdetail.province, compdetail.company, compdetail.subadd)
    ...
    const addcomp = (value) => {
        ...
        axios.post('http://localhost:3001/insertaddress', {
    ...
    const onChangedistrict2 = (index) => {
        setsel(index.value)
        setcompdetail({
            ...compdetail, distri: company[index.index].district,
    ...
    const del = () => {
        console.log(sel)
        axios.delete(`http://localhost:3001/delcompany/${sel}`, {
        })
            .then(function (response) {
                getAddress()
            })
    ...
    const columns = [
...

        {
            ...
            cell: row => <button className="btn btn-primary editbutton"
                onClick={() => alert(row.alpha2Code)}>ตรวจสอบเอกสาร</button>,
                    ...
                    <Modal.Body>
                        <Form>
                            <Form.Group>
                                ...
                                <Select options={options} value={options.index} onChange={(e) => onChangedistrict2(e)} />
                            </Form.Group>
                            <Form.Group  >
                                <Form.Label>ชื่อหน่วยงาน</Form.Label>
                                <Form.Control placeholder="" value={compdetail.company}
                                    onChange={(event) =>
                                        setcompdetail({ ...compdetail, company: event.target.value })
                                    } />
                            </Form.Group>
                            <Form.Group  >
                                <Form.Label>บ้านเลขที่</Form.Label>
                                <Form.Control placeholder="" value={compdetail.subadd}
                                    onChange={(event) =>
                            ...
                            <Form.Group  >
                                ...
                                <Form.Control type="text" value={compdetail.distri}
                                    onChange={(event) =>
                            ...
                            <Form.Group >
                                ...
                                <Form.Control type="text" value={compdetail.amphoe}
                                    onChange={(event) =>
                            ...
                            <Form.Group>
                                ...
                                <Form.Control type="text" value={compdetail.province}
                                    onChange={(event) =>
                                        setcompdetail({ ...compdetail, province: event.target.value })
                                    } />
                            </Form.Group>
                            <Form.Group>
                                <Form.Label>Username</Form.Label>
                                <Form.Control type="text" value={compdetail.username}
                                    onChange={(event) =>
                                        setcompdetail({ ...compdetail, username: event.target.value })
                                    } />
                            </Form.Group>
                            <Form.Group>
                                <Form.Label>Password</Form.Label>
                                <Form.Control type="text" value={compdetail.password}
                                    onChange={(event) =>
                                        setcompdetail({ ...compdetail, password: event.target.value })
                                    } />
                            </Form.Group>
                        </Form>
                    </Modal.Body>
