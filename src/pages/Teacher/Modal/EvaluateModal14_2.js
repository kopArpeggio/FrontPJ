...
function EvaluateModal14_2({ show, handleClose, student, setStudent }) {
        ...
        if (results.isConfirmed) {
          const done = await updateEvaluateById({
            ...
            fcn14_2Point:
              ...
              score?.score13 +
              score?.score14,
            fcn14_2Comment: score?.fcn14_2Comment,
          });
          ...
          <Form noValidate validated={validated} onSubmit={handleSubmit}>
            ...
            >
              ...
              <Col sm={3} className="d-flex justify-content-start">
                ...
                <Form.Control min={0} max={5} type="number" onChange={(e) =>
            ...
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
              ...
              <Form.Control
                ...
                required
                onChange={(e) => {
                  setScore({ ...score, fcn14_2Comment: e?.target?.value })
                }}
                style={{ height: "100px" }}
              />
            </Form.Group>
...
export default EvaluateModal14_2;
